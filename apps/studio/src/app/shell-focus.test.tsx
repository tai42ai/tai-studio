 ...
 *
 * The invariant these tests pin: a same-pathname search-only PUSH must NOT set
 * the "focus the next heading" flag. The pathname-keyed consumer never runs when
 * the pathname did not change, so a set flag would STRAND until the next real
