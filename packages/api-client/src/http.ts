...
/**
 * Fetch a plain-text endpoint (the skeleton's `/health` → `"OK"` and `/metrics`
 * → Prometheus text). No `{ data }` envelope, no zod — the body is returned
 * verbatim. Non-2xx still throws loudly.
 */
