...
function renderGate(client: StubApiClient, route = 'web-support') {
...
describe('EntryGate — classification', () => {
  const nonWebCases: { name: string; route: ReturnType<typeof makeRoute> }[] = [
    { name: 'an api-door route', route: makeRoute({ route_name: 'web-support', door: 'api' }) },
    {
