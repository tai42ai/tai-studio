...
describe('CopyField', () => {
  ...
  it('says so when the browser offers no clipboard at all', async () => {
    // Any non-secure context: `navigator.clipboard` does not exist; reading through
    // it throws a TypeError straight out of the click handler, so the handler must
    // guard the absence and report it.
